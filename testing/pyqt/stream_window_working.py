...
class StreamWindow(QMainWindow):
    ...
    def get_video_layout(self):
        ...
        self.layout_raw = low_res_layout()
        self.layout.addLayout(self.layout_raw)
        return self.layout
    ...
    def initUI(self):
        ...
        self.layout_outter.addLayout(self.get_video_layout())

        self.widget_stream = QWidget()
        self.widget_stream.setLayout(self.layout_outter)
        self.setCentralWidget(self.widget_stream)
    ...
    def paintEvent(self, event):
        print("paint")
        print(self.geometry())
        print(self.widget_stream.geometry())
        print(self.layout.geometry())
        print(self.layout_raw.geometry())
        print(self.layout_outter.geometry())
        print(self.video_container.geometry())
